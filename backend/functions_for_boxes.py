...
lst_cargo_material = {"дерево" : None,
	                  "сталь" : None,
	                  "пакеты чушек свинца, цинка" : None,
	                  "пакеты отливок алюминия" : None,
	                  "железобетон" : None,
	                  "вертикально устанавливаемые рулоны листовой стали" : None,
	                  "пачки промасленной листовой стали" : None}
